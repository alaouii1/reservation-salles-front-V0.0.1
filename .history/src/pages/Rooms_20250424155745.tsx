    ...
    <div className="p-8 max-w-7xl mx-auto bg-gray-50">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 mb-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          {/* Nom de salle */}
          <div>
            <label htmlFor="room-search" className="block text-sm font-medium text-gray-700 mb-2">Nom de salle</label>
          ...
          {/* Local */}
          <div>
            <label htmlFor="location-select" className="block text-sm font-medium text-gray-700 mb-2">Local</label>
            <select
              id="location-select"
              className="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent appearance-none bg-white"
          ...
          {/* Date */}
          <div className="relative">
            <label htmlFor="date-input" className="block text-sm font-medium text-gray-700 mb-2">Date</label>
            <div className="relative">
              <input
                ref={dateInputRef}
                id="date-input"
                ...
                className="w-full pl-4 pr-10 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                value={dateInput}
          ...
          {/* Début */}
          <div>
            <label htmlFor="start-time" className="block text-sm font-medium text-gray-700 mb-2">Début</label>
            <div className="relative" ref={timePickerRef}>
              ...
              {showStartTimePicker && (
                <div className="absolute top-full left-0 mt-1 bg-white rounded-xl shadow-lg z-10 w-full max-h-48 overflow-y-auto border border-gray-200">
          ...
          {/* Fin */}
          <div>
            <label htmlFor="end-time" className="block text-sm font-medium text-gray-700 mb-2">Fin</label>
            <div className="relative" ref={timePickerRef}>
              <input
                id="end-time"
                type="text"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredSalles.map((salle) => (
          ...
          >
            ...
            <div className="flex items-right justify-between mt-auto">
